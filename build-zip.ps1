...
$exclude = @(
    "build-zip.ps1",        # ten skrypt
    "migrate_nav.py",       # skrypt deweloperski
    "update_blog.py",       # skrypt deweloperski
    "CLAUDE.md",            # instrukcje dla AI
    "thumbnail-style-guide.md", # notes graficzne
    ".claude",              # folder Claude Code
...
Write-Host ""
Write-Host "✓ Gotowe: etfkalkulator-deploy.zip ($sizeMB MB)" -ForegroundColor Green
